        ...
        <>
            <header className="repbar">
                <div className="repbar-inner">
                    <div className="wordmark">we do sales<span>.</span></div>
        ...
        return (
            <div className="done show">
                ...
                <div className="receipt">
                    <dl>
                        <dt>Reference</dt><dd>{kvittering.reference}</dd>
                        <dt>Navn</dt><dd>{kvittering.navn}</dd>
                        <dt>Telefon</dt>
                        <dd>
                        ...
                        <dt>Sælger</dt><dd>{kvittering.saelger}</dd>
                        <dt>Konsulent</dt><dd>{kvittering.konsulent}</dd>
                    </dl>
                    ...
                    <details>
                        ...
                        <div className="body">
                            <p>
                                ...
                                ved. Et kryds ved ét selskab giver ikke de andre lov til at
                                kontakte dig. Selskaberne deler ikke dine oplysninger
                                indbyrdes.
                            </p>
                            <p>
                            ...
                            <p>
                                ...
                                samme som at indgå en aftale — du binder dig ikke til at
                                købe noget.
                            </p>
                            <p>
